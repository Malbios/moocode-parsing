...
`;
  ...
  test('should parse a while loop with outer name', () => {
    const code = `
while name (true)
  x();
endwhile
`;
  ...
  test('should parse a while loop with inner name', () => {
    const code = `
while (name = true)
  x();
endwhile
`;
    ...
    ExpectHelpers.expectIdentifier(whileStatement?._inner_name, 'name');
